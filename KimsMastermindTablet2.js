...
CodePlusButton.prototype=Object.create(Button.prototype);
...
var codePlus=new CodePlusButton(reset.PosX-guessWidth-spacing,300,actionCols[3],reset.bHeight,reset.bHeight);
println(codePlus.posX + "  " + codePlusY);
